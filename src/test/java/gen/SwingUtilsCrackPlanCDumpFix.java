...
public class SwingUtilsCrackPlanCDumpFix implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/eviware/soapui/support/swing/SwingUtils", null, "java/lang/Object", new String[] { "com/eviware/soapui/support/UIUtils" });
...
methodVisitor.visitLocalVariable("var3", "Ljava/lang/InterruptedException;", null, label8, label3, 2);
methodVisitor.visitLocalVariable("var4", "Ljava/lang/reflect/InvocationTargetException;", null, label9, label7, 2);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljava/awt/Component;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
...
Label label10 = new Label();
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"java/util/List", "java/awt/Container", Opcodes.INTEGER, "[Ljava/lang/Class;", "[Ljava/awt/Component;", Opcodes.INTEGER, Opcodes.INTEGER, "java/awt/Component", "[Ljava/lang/Class;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitLineNumber(105, label18);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitLineNumber(91, label17);
