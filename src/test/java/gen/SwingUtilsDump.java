...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/SecurityException", "getStackTrace", "()[Ljava/lang/StackTraceElement;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label5 = new Label();
methodVisitor.visitLabel(label5);
...
methodVisitor.visitLdcInsn("com.smartbear.ready.license.LicenseHandlingTest");
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label9);
methodVisitor.visitLineNumber(57, label9);
...
methodVisitor.visitTypeInsn(NEW, "com/eviware/soapui/support/swing/SwingUtils$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/eviware/soapui/support/swing/SwingUtils$1", "<init>", "()V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/swing/SwingUtilities", "invokeLater", "(Ljava/lang/Runnable;)V", false);
...
methodVisitor.visitLocalVariable("status", "I", null, label0, label12, 0);
methodVisitor.visitLocalVariable("e", "Ljava/lang/SecurityException;", null, label4, label3, 1);
methodVisitor.visitLocalVariable("stackTrace", "[Ljava/lang/StackTraceElement;", null, label5, label3, 2);
methodVisitor.visitLocalVariable("stackTraceElement", "Ljava/lang/StackTraceElement;", null, label8, label9, 3);
