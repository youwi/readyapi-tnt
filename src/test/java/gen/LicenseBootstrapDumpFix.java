...
public class LicenseBootstrapDumpFix implements Opcodes {
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 0, new Object[] {}, 1, new Object[] {"java/util/prefs/BackingStoreException"});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"com/smartbear/ready/license/LicenseBootstrap", "java/net/URL"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/util/prefs/BackingStoreException"});
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"com/smartbear/ready/license/exception/InvalidLicenseException"});
methodVisitor.visitVarInsn(ASTORE, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/util/prefs/BackingStoreException"});
methodVisitor.visitInsn(POP);
...
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {Opcodes.TOP, "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label8);
